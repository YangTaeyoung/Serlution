  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">연관 검색어</h1>
      </div>
      
      <canvas class="my-4 w-100" id="myDonut" width="900" height="380"></canvas>
...
<script>
	//차트 색상들
	var colors = ['#cce6ff','#d98c8c','#ffd9b3','#ffffb3','#adebad','#b3e6cc','#00cca3','#8080ff','#b366ff','#aa80ff'];
	...
	var myDonut = document.getElementById("myDonut");
	if (myDonut) { 
		new Chart(myDonut, {
			type: 'pie', 
			data: donutData, 
