...
public class SearchDAO {
	...
	public void createTable(String tableName)
	{
		...
		String sql = "CREATE TABLE " + tableName + " (ser_no INT PRIMARY KEY  AUTO_INCREMENT, ser_title TEXT, ser_content TEXT, ser_link TEXT, ser_date TEXT) CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci";
	...
	{
		String sql = "select * from " + keyword.toLowerCase();
	...
	{
		String sql = "select * from " + keyword.toLowerCase() + " where ser_no = ?";
	...
	{		
		String sql = "insert into " + keyword.toLowerCase() + " (ser_title, ser_content, ser_link, ser_date) values(?,?,?,?)";
